...
class hdf5dataset(Dataset):
    ...
    def __init__(self, h5_path, shape = (7,32,32), training = True, transforms=None):
        ...
        '''
        #weight the classes by the final reporting method e.g. combining S1 and S2 
        PCT_count = count_labels["class_1"] + count_labels["class_2"]
        #count_labels["class_1"] = PCT_count
        #count_labels["class_2"] = PCT_count
        if len(count_labels) > 10:
            CD45_count = count_labels["class_6"] + count_labels["class_10"] + count_labels["class_11"] + count_labels["class_12"] + count_labels["class_13"]
            count_labels["class_6"] = CD45_count
            count_labels["class_10"] = CD45_count
            count_labels["class_11"] = CD45_count
            count_labels["class_12"] = CD45_count
            count_labels["class_13"] = CD45_count
        ###########################################################
        '''
